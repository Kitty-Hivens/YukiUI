    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject bar: JsonObject {
                ...
                property string topLeftIcon: "spark" // Options: "distro" or any icon name in ~/.config/quickshell/yuki/assets/icons
            ...
            property JsonObject networking: JsonObject {
                // Naming the client beats impersonating a browser: Cloudflare challenges a
                // Chrome user agent that arrives without a Chrome TLS fingerprint, which is
                // what turned every Danbooru request -- api and cdn alike -- into a 403.
                property string userAgent: "YukiUI-Shell/1.0 (+https://github.com/Kitty-Hivens/YukiUI)"
            }
