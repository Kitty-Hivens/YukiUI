...
# The runtime directory rather than /tmp: a copy of the wallpaper is still a
# picture off this user's machine, and /tmp is readable by every account on it.
...
mkdir -p -m 700 "$(dirname "$RESIZED_IMG_PATH")"
