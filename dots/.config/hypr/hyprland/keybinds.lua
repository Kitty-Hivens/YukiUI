...
hl.bind("CTRL + SUPER + R", hl.dsp.exec_cmd("killall ydotool qs quickshell; uwsm app -a quickshell -p MemoryLow=350M -- systemd-cat --identifier=quickshell qs --no-color -c $qsConfig"),
