...
hl.bind("CTRL + SUPER + R", hl.dsp.exec_cmd("killall ydotool qs quickshell; uwsm app -a quickshell -p MemoryLow=350M -- $HOME/.config/hypr/hyprland/scripts/launch_shell.sh $qsConfig"),
